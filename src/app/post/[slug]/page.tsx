...
export default async function PostPage({ params }: { params: { slug: string } }) {
  ...
  return (
    <main className="container mx-auto p-4">
      <article className="bg-gray-400 p-6 rounded-lg shadow-md">
        <h1 className="text-black text-3xl font-bold hover:underline hover:text-white hover:scale-y-125 mb-4">
          {post.title}
        </h1>
        <p className="text-black text-lg md:text-lg lg:text-lg font-bold hover:underline hover:text-white hover:scale-y-125 mb-4">
  ...
  <div className="bg-gray-300 w-full h-48 flex items-center justify-center">
    <span className="text-gray-700">No Image</span>
      ...
      <section className="mt-8 p-4 bg-gray-400 rounded-lg">
        <h3 className="text-black text-lg font-bold hover:underline hover:text-white hover:scale-y-125 mb-4">
          About the Author
        </h3>
        <div className="flex items-center space-x-4">
          ...
          {/* Author's name */}
          <p className="text-black font-bold hover:text-white">
